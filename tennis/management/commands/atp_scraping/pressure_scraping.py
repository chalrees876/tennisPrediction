...
def main():
    url = ("https://www.atptour.com/en/stats/leaderboard?boardType=pressure&timeFrame=52week&surface=all&versusRank=all&formerNo1=false")
    ...
    for row in rows:
        ...
        for i, column in enumerate(columns):
            if i == 1:
                ...
                continue
        player_stats_dict = dict(zip(header_list, [name, serve_rating, bp, fspw, sspw, sgwp]))
    ...
    player_stats = player_stats.drop('% Break Points Converted')
    player_stats.show()

    player_stats.coalesce(1).write.csv('/Users/chrismckenzie/Downloads/tennisprediction/tennis/management/commands/atp_scraping/data/separate_data/pressure_data',
